...
export const CRYPTO_UTIL_KEY_DESC = {
  ...
  hash: {
    name: ENCRYPTION_FORMAT_SUPPORTED || HASH_CALCULATION_UTILS_HASH_ALHORITHM.SHA256,
  },
};
...
export const CRYPTO_UTIL_DATA_SIGN_PUBLIC_KEY_USAGE = eCRYPTO_UTILS_KEYS_USAGES.verify;

export const CRYPTO_UTIL_DATA_SIGN_PRIVATE_KEY_USAGE = eCRYPTO_UTILS_KEYS_USAGES.sign;
...
export const CRYPTO_UTIL_KEYPAIR_USAGES = [CRYPTO_UTIL_PUBLIC_KEY_USAGE, CRYPTO_UTIL_PRIVATE_KEY_USAGE];
