...
import { ISwarmMessageStoreConectorDbOptionsGrandAccessContext } from '../../../../../../types/swarm-message-store-db-options.types';
...
export function getSwarmStoreConectorDbOptionsGrandAccessContextClass<
  ...
  BC extends ConstructorType<ISwarmStoreConnectoDbOptionsUtilsGrandAccessCallbackContext>
>(
  BaseContext: BC,
  params: ISwarmMessageStoreConectorDbOptionsGrandAccessContextClassFabricParams<SMC>
): BC & ConstructorType<ISwarmMessageStoreConectorDbOptionsGrandAccessContext<SMC>> {
  class SwarmStoreConectorDbOptionsGrandAccessContextExtended
    extends BaseContext
    implements ISwarmMessageStoreConectorDbOptionsGrandAccessContext<SMC> {
    get dbName(): string {
