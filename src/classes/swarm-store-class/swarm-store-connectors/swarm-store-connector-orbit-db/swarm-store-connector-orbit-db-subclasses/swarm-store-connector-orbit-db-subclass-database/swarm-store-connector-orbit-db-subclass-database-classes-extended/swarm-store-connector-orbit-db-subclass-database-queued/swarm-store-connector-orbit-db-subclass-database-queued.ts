...
> extends SwarmStoreConnectorOrbitDBDatabase<TStoreValue, DbType>
  ...
  public connect = async (
    ...args: ArgumentTypes<
      SwarmStoreConnectorOrbitDBDatabase<TStoreValue, DbType>['connect']
    >
  ): ReturnType<
    SwarmStoreConnectorOrbitDBDatabase<TStoreValue, DbType>['close']
  > => {
  ...
  public drop = async (
    ...args: ArgumentTypes<
      SwarmStoreConnectorOrbitDBDatabase<TStoreValue, DbType>['drop']
    >
  ): ReturnType<
    SwarmStoreConnectorOrbitDBDatabase<TStoreValue, DbType>['drop']
  > => {
  ...
  public load = async (
    ...args: ArgumentTypes<
      SwarmStoreConnectorOrbitDBDatabase<TStoreValue, DbType>['load']
    >
  ): ReturnType<
    SwarmStoreConnectorOrbitDBDatabase<TStoreValue, DbType>['load']
  > => {
  ...
  public add = async (
    ...args: ArgumentTypes<
      SwarmStoreConnectorOrbitDBDatabase<TStoreValue, DbType>['add']
    >
  ): ReturnType<
    SwarmStoreConnectorOrbitDBDatabase<TStoreValue, DbType>['add']
  > => {
  ...
  public get = async (
    ...args: ArgumentTypes<
      SwarmStoreConnectorOrbitDBDatabase<TStoreValue, DbType>['get']
    >
  ): ReturnType<
    SwarmStoreConnectorOrbitDBDatabase<TStoreValue, DbType>['get']
  > => {
  ...
  public remove = async (
    ...args: ArgumentTypes<
      SwarmStoreConnectorOrbitDBDatabase<TStoreValue, DbType>['remove']
    >
  ): ReturnType<
    SwarmStoreConnectorOrbitDBDatabase<TStoreValue, DbType>['remove']
  > => {
  ...
  public iterator = async (
    ...args: ArgumentTypes<
      SwarmStoreConnectorOrbitDBDatabase<TStoreValue, DbType>['iterator']
    >
  ): ReturnType<
    SwarmStoreConnectorOrbitDBDatabase<TStoreValue, DbType>['iterator']
  > => {
  ...
  protected _initializeAsyncQueue() {
    this._asyncOperationsQueue = new ConcurentAsyncQueue<void, Error>(
  ...
  protected _rejectAllPendingOperationsOnDbOpen(): Promise<void> {
    return this._rejectAllPendingOperations(
      new Error('Datatabase opened again')
    );
  }
