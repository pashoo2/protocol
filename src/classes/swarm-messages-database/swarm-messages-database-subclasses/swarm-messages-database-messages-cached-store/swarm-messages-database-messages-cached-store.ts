...
export function constructCacheStore<P extends ESwarmStoreConnector, DbType extends TSwarmStoreDatabaseType<P>, IsTemp extends boolean>(
  dbType: DbType,
  dbName: string,
  isTemp: IsTemp
) {
...
>(): ISwarmMessagesDatabaseMessagesCacheStoreFabric<P, DbType, IsTemp> {
  return (constructCacheStore as unknown) as ISwarmMessagesDatabaseMessagesCacheStoreFabric<P, DbType, IsTemp>;
})();
