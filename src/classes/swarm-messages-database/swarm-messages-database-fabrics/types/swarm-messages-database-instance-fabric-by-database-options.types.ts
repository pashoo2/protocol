 ...
 *
 * @export
 * @interface ISwarmMessagesDatabaseConnectedInstanceFabricByDatabaseOptions
 * @template P
 * @template T
 * @template DbType
 * @template DBO
 ...
 * @template OPT
 */
export interface ISwarmMessagesDatabaseConnectedInstanceFabricByDatabaseOptions<
