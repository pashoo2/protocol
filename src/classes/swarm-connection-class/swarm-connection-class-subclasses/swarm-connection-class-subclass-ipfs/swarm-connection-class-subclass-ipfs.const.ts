import {
  SWARM_CONNECTION_SUBLASS_IPFS_CONFIG_FOR_BROWSER_DEFAULT,
  SWARM_CONNECTION_SUBLASS_IPFS_CONFIG_NODES_BOOTSTRAP,
...
export const SWARM_CONNECTION_SUBLASS_IPFS_CONFIG_DEFALT = {
  init: {
  ...
  preload: {
    enabled: true,
    addresses: SWARM_CONNECTION_SUBLASS_IPFS_CONFIG_NODES_BOOTSTRAP,
  },
  EXPERIMENTAL: {
    ipnsPubsub: true,
    sharding: true,
  },
  config: SWARM_CONNECTION_SUBLASS_IPFS_CONFIG_FOR_BROWSER_DEFAULT,
