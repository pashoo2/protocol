 ...
 *  */
export const SWARM_CONNECTION_SUBCLASS_IPFS_CONFIG_BOOTSTRAP_NODE_HTTP_PORT = '4001';
export const SWARM_CONNECTION_SUBCLASS_IPFS_CONFIG_BOOTSTRAP_NODE_WS_PORT = '4003';
