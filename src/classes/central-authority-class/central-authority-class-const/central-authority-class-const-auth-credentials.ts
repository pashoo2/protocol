...
export const CA_USER_IDENTITY_AUTHORITY_URI_IDENTIFIER_MIN_LENGTH = 36;

export const CA_USER_IDENTITY_AUTHORITY_URI_IDENTIFIER_MAX_LENGTH = 36;

export const CA_USER_IDENTITY_MIN_LENGTH =
  CA_USER_IDENTITY_AUTHORITY_URI_IDENTIFIER_MIN_LENGTH +
  CA_USER_IDENTITY_UNIQUE_IDENTIFIER_MIN_LENGTH;

export const CA_USER_IDENTITY_MAX_LENGTH =
  CA_USER_IDENTITY_AUTHORITY_URI_IDENTIFIER_MAX_LENGTH +
