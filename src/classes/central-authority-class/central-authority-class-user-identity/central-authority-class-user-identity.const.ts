...
export const CA_USER_IDENTITY_VERSIONS_LIST = Object.values(CA_USER_IDENTITY_VERSIONS);

export const CA_USER_IDENTITY_PARSER_VERSIONS_SUPPORTED = Object.values(CA_USER_IDENTITY_VERSIONS);
 ...
 * provider
 */
export const CA_USER_IDENTITY_AUTH_PROVIDER_IDENTIFIER_PROP_NAME = 'authorityProviderURI';
 ...
 */
export const CA_USER_IDENTITY_USER_UNIQUE_IDENTFIER_PROP_NAME = 'userUniqueIdentifier';
