...
export const CA_USER_IDENTITY_PARSER_IDENTITY_MIN_CHARACTERS_COUNT =
  CA_USER_IDENTITY_UNIQUE_IDENTIFIER_MIN_LENGTH + CA_USER_IDENTITY_AUTHORITY_IDENTIFIER_MIN_LENGTH;
...
export const CA_USER_IDENTITY_PARSER_IDENTITY_MAX_CHARACTERS_COUNT =
  CA_USER_IDENTITY_UNIQUE_IDENTIFIER_MAX_LENGTH + CA_USER_IDENTITY_AUTHORITY_IDENTIFIER_MAX_LENGTH + 1;
