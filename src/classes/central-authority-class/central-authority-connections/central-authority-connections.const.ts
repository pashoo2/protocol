import CAConnectionWithFirebaseBase from './central-authority-connection-firebase/central-authority-connection-firebase-base/central-authority-connection-firebase-base';
...
export const CA_CONNECTIONS_POOL_AUTH_PROVIDERS_CONNECTION_CONSTRUCTORS = {
  [CA_CONNECTION_AUTH_PROVIDERS.FIREBASE]: CAConnectionWithFirebaseBase,
};
...
export const CA_CONNECTIONS_POOL_AUTH_PROVIDERS_CONNECTION_CONFIGURATION_VALIDATORS = {
  [CA_CONNECTION_AUTH_PROVIDERS.FIREBASE]:
    CAConnectionWithFirebaseBase.validateConfiguration,
};
