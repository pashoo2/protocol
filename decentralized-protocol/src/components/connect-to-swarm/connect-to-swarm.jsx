...
export class ConnectToSwarm extends React.PureComponent {
    constructor() {
        ...
        this.connectToSwarm = (credentials) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const connectionBridge = yield connectToSwarmUtil(this.props.connectionBridgeOptions, credentials);
        ...
        this.getOptionsForSwarmMessagesDatabaseConnectedFabric = (dbsOptions) => {
            ...
            const dbOptions = Object.assign(Object.assign({}, dbsOptions), { grantAccess: (...args) => __awaiter(this, void 0, void 0, function* () {
                    console.log(...args);
                    return true;
                }) });
            return {
...
//# sourceMappingURL=connect-to-swarm.jsx.map