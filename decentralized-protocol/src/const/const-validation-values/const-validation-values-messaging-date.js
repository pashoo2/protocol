import { CONST_VALUES_RESTRICTIONS_COMMON_CURRENT_DATE_MAX_ERROR_SECONDS } from "../const-values-restrictions-common";
...
export const CONST_VALIDATION_VALUES_TIMESTAMP_UNIX_MIN_S = getSecondsByMilliseconds(Date.UTC(Number(CONST_VALIDATION_VALUES_MESSAGING_DATE_MIN_YEAR), Number(CONST_VALIDATION_VALUES_MESSAGING_DATE_MIN_YEAR_MONTH), Number(CONST_VALIDATION_VALUES_MESSAGING_DATE_MIN_YEAR_MONTH_DAY)));
//# sourceMappingURL=const-validation-values-messaging-date.js.map