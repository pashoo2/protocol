...
import { CA_USER_IDENTITY_VERSION_PROP_NAME, CA_USER_IDENTITY_VERSION_CHARACTERS_COUNT, CA_USER_IDENTITY_PARSER_VERSIONS_SUPPORTED, } from '../central-authority-class-user-identity.const';
import { dataValidatorUtilURL } from "../../../../utils/data-validators-utils";
export const validateIdentityDescriptionVersion = (version) => {
...
export const getValidatorByIdentityVersion = (identityVersion) => {
...
export const validateUserIdentityDescriptionVersion = (identityVersion, userIdentityDescription) => {
...
export const validateUserIdentityDescription = (userIdetnityDescription) => {
...
export const checkIsValidUserIdentityMetadata = (identityMetadata) => {
    ...
    const { [CA_USER_IDENTITY_VERSION_PROP_NAME]: version, [CA_USER_IDENTITY_AUTH_PROVIDER_IDENTIFIER_PROP_NAME]: authorityProviderURI, } = identityMetadata;
...
//# sourceMappingURL=central-authority-class-user-identity-validators.utils.js.map