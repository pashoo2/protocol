...
import { CA_USER_IDENTITY_AUTH_PROVIDER_IDENTIFIER_PROP_NAME, CA_USER_IDENTITY_VERSION_PROP_NAME, CA_USER_IDENTITY_USER_UNIQUE_IDENTFIER_PROP_NAME, CA_USER_IDENTITY_VERSION_CHARACTERS_COUNT, } from '../../central-authority-class-user-identity.const';
import { dataValidatorUtilUUIDV4 } from "../../../../../utils/data-validators-utils/data-validators-utils-common";
export const validatorV1 = (v) => {
    if (v && typeof v === 'object') {
        const { [CA_USER_IDENTITY_USER_UNIQUE_IDENTFIER_PROP_NAME]: userUniqueIdentifier, [CA_USER_IDENTITY_VERSION_PROP_NAME]: version, [CA_USER_IDENTITY_AUTH_PROVIDER_IDENTIFIER_PROP_NAME]: authProviderURI, } = v;
...
//# sourceMappingURL=central-authority-class-user-identity-validator-v1.js.map