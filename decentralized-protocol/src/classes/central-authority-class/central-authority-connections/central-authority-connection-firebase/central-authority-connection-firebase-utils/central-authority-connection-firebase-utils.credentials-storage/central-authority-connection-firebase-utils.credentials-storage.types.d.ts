...
export interface ICAConnectionFirestoreUtilsCredentialsStrorage {
    setUserCredentials(userId: TSwarmMessageUserIdentifierSerialized, cryptoCredentials: TCentralAuthorityUserCryptoCredentials): Promise<Error | boolean>;
...
//# sourceMappingURL=central-authority-connection-firebase-utils.credentials-storage.types.d.ts.map