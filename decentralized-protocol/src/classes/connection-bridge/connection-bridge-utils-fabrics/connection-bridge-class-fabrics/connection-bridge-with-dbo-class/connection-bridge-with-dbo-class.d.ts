...
import { TSwarmMessageSerialized, TSwarmMessageInstance, ISwarmMessageConstructor } from '../../../../swarm-message/swarm-message-constructor.types';
import { TSwarmStoreDatabaseType, TSwarmStoreDatabaseOptions, TSwarmStoreConnectorConnectionOptions, ISwarmStoreProviderOptions, ISwarmStoreOptionsConnectorFabric, TSwarmStoreConnectorBasicFabric } from '../../../../swarm-store-class/swarm-store-class.types';
...
import { TSwarmStoreDatabaseOptionsSerialized, ISwarmStoreDatabaseBaseOptions } from '../../../../swarm-store-class/swarm-store-class.types';
...
export declare class ConnectionBridgeWithDBOClassEntriesCount<P extends ESwarmStoreConnector, T extends TSwarmMessageSerialized, DbType extends TSwarmStoreDatabaseType<P>, MSI extends TSwarmMessageInstance | T, CTX extends ISwarmStoreDBOGrandAccessCallbackBaseContext, DBO extends TSwarmStoreDatabaseOptions<P, T, DbType>, DBOE extends DBO & ISwarmStoreDatabaseBaseOptions & {
    ...
    protected __createSarmMessageStoreDatabaseOptionsClassFabric<SMSDBOCFF extends (serializer: SRLZR) => DBOCF>(swarmMessageStoreDatabaseOptionsClassFabricOfFabric: SMSDBOCFF, options: {
        serializer: SRLZR;
    }): DBOCF;
    protected __crateAndGetSwarmMessageStoreDatabaseOptionsClassFabric(): ReturnType<CBO['storage']['swarmMessageStoreDatabaseOptionsClassFabricOfFabric']>;
...
//# sourceMappingURL=connection-bridge-with-dbo-class.d.ts.map