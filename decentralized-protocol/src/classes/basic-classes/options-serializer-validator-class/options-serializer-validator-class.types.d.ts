...
export interface IOptionsSerializerValidatorConstructor<OPTS, OPTSSERIALIZED extends string> {
    new (params: IOptionsSerializerValidatorConstructorParams<OPTS, OPTSSERIALIZED>): IOptionsSerializerValidator<OPTS, OPTSSERIALIZED>;
}
//# sourceMappingURL=options-serializer-validator-class.types.d.ts.map